...
export default function GatePage() {
  ...
  return (
    <main id="main-content" className="min-h-screen flex items-center justify-center bg-[var(--background)] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-600/20 to-purple-700/10 border border-violet-500/30 flex items-center justify-center mx-auto mb-5">
            <Lock size={24} className="text-violet-300" aria-hidden="true" />
          </div>
          <h1 id="gate-heading" className="text-xl font-semibold text-gray-100">RepoScope</h1>
          <p className="text-sm text-gray-400 mt-1">Private demo - enter the access code</p>
        </div>

        <form onSubmit={handleSubmit} noValidate className="space-y-4" aria-labelledby="gate-heading">
          <label htmlFor="gate-access-code" className="sr-only">
            Access code
          </label>
          <input
            id="gate-access-code"
